...
const overallPctSubStyle: React.CSSProperties = { color: '#C8E2FF', opacity: 0.7 }
              ...
              {[
                ...
                <div key={item.label} className="flex flex-col gap-2">
                  ...
                  <div className="h-1.5 rounded-full" style={barTrackStyle}>
                    <div className="h-full rounded-full transition-all" style={barFillStyle((item.completed / item.total) * 100)} />
                  </div>
                </div>
              ))}
            </div>
